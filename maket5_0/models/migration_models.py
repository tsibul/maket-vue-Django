...
fs_films_m = FileSystemStorage(location='files_m/films')
...
class Z_Customer_groups(models.Model):
    group_name = models.CharField(max_length=255, unique=True)
    group_type = models.ForeignKey(Z_Customer_types, models.SET_NULL, null=True)
...
class Z_Customer_all(models.Model):
    ...
    customer_group = models.ForeignKey(Z_Customer_groups, models.SET_NULL, null=True, default=None)
    customer_type = models.ForeignKey(Z_Customer_types, models.SET_NULL, null=True, default=None)
...
class Z_Customer(models.Model):
    ...
    customer_group = models.ForeignKey(Z_Customer_groups, models.SET_NULL, null=True, default=None)
    customer_type = models.ForeignKey(Z_Customer_types, models.SET_NULL, null=True, default=None)
    customer_all = models.ForeignKey(Z_Customer_all, models.SET_NULL, null=True, default=None)
...
class Z_Color_scheme(models.Model):
...
class Z_Item_color(models.Model):
    """ id - (07)
        name - name
    ...
    color_scheme = models.ForeignKey(Z_Color_scheme, models.SET_NULL, null=True)
...
class Z_Print_group(models.Model):
    ...
    pattern_file = models.FileField(storage=fs_patterns_m, null=True, blank=True)
...
class Z_Print_type(models.Model):
...
class Z_Print_place(models.Model):
...
class Z_Print_position(models.Model):
    """ option - open/close pen, plain round
        orientation - left, right, opposite, back"""
    position_place = models.ForeignKey(Z_Print_place, models.SET_NULL, null=True)
    print_group = models.ForeignKey(Z_Print_group, on_delete=models.CASCADE, null=True)
    orientation_id = models.SmallIntegerField(default=1)
    position_orientation = models.CharField(max_length=20)


class Z_Manger(models.Model):
    """Customer managers """
...
class Z_Good_matrix_type(models.Model):
...
class Z_Good_crm_type(models.Model):
...
class Z_Detail_set(models.Model):
    ...
    matrix = models.ForeignKey(Z_Good_matrix_type, models.SET_NULL, null=True, default=None)
    crm = models.ForeignKey(Z_Good_crm_type,  models.SET_NULL, null=True, default=None)
    color_scheme = models.ForeignKey(Z_Color_scheme, models.SET_NULL, null=True)
    print_group = models.ForeignKey(Z_Print_group, models.SET_NULL, null=True, blank=True)
...
class Z_Order_imports(models.Model):
    ...
    customer = models.ForeignKey(Z_Customer, models.SET_NULL, null=True)
    ...
    manager = models.ForeignKey(Z_Manger, models.SET_NULL, blank=True, null=True, default='')
    Ready = 'R'
    Partial = 'P'
    NotReady = 'N'
    ...
    order_file = models.FileField(storage=fs_orders_m, null=True, blank=True)
...
class Z_Item_imports(models.Model):
    ...
    item = models.ForeignKey(Z_Detail_set, models.SET_NULL, null=True)
...
class Z_Print_imports(models.Model):
    """quantity - number of colors
        shots - number of shots 1 or 2"""
    place = models.CharField(max_length=30, blank=True, null=True)
    print_place = models.ForeignKey(Z_Print_place, models.SET_NULL, null=True)
    type = models.CharField(max_length=30, blank=True, null=True)
    colors = models.SmallIntegerField(default=1)
    second_pass = models.BooleanField(default=False)
    item = models.ForeignKey(Z_Item_imports, on_delete=models.CASCADE, null=True)
    print_id = models.IntegerField(default=0)
    print_price = models.FloatField(default=0)
    print_position = models.ForeignKey(Z_Print_position, models.SET_NULL, null=True, default='')


class Z_Print_color(models.Model):
    """Colors of printing"""
    ...
    print_item = models.ForeignKey(Z_Print_imports, on_delete=models.CASCADE)
...
class Z_Films(models.Model):
    ...
    film_file = models.FileField(storage=fs_films_m, null=True, blank=True)
...
class Z_Item_in_Film(models.Model):
    """If item correctly outputed in film"""
    item = models.ForeignKey(Z_Item_imports, models.SET_NULL, null=True, blank=True)
    film = models.ForeignKey(Z_Films, models.SET_NULL, null=True, blank=True)
    status = models.BooleanField(default=True)


class Z_Additional_Files(models.Model):
    """Additional files"""
    additional_file = models.FileField(storage=fs_additional_m, null=True, blank=True)
    ...
    comment = models.CharField(max_length=255, null=True, blank=True)
    order_id = models.ForeignKey(Z_Order_imports, on_delete=models.CASCADE)
